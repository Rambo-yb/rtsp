...
{
public:
    static AACRtpSink* createNew(UsageEnvironment* env, MediaSource* mediaSource, int sample_rate, int channels);;
    
    AACRtpSink(UsageEnvironment* env, MediaSource* mediaSource, int sample_rate, int channels);
    virtual ~AACRtpSink();
